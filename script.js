...
function showTrophy(el){
	...
	document.getElementById("pats").src = "images/raiders.png";
	document.getElementById("rams").src = "images/raiders.png";
	document.getElementById("trophy").src = "images/raiders.png";
}